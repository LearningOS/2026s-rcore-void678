...
impl Inode {
    ...
    /// Count directory entries that point to an inode.
    ...
    /// Return this inode's id in the filesystem.
    ...
    /// Create a hard link under current directory.
    ...
    /// Count hard links pointing at this inode from the root directory.
    pub fn nlink(&self) -> u32 {
        let inode_id = self.inode_id();
        self.read_disk_inode(|_| {
            let root_inode_id = 0;
